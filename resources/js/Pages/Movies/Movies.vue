        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg"></div>
          <div class="bg-white">
            <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Pablo Carro</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">Challenge</h3>
                        ...
                        <span class="block text-center text-gray-500">OnMedia</span>
                    </div>
                    <table class="w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">API pública</td>
                                <td class="text-gray-500">Omdb</td>
                                <td>
          ...
          <div class="bg-white">
            ...
            >
              <div class="grid grid-cols-3 gap-4">
                ...
                <div class="...">
                  <input type="text" v-model="busqueda" placeholder="Busca tu peli" />
                  <button
                    class="
                      bg-blue-500
                      hover:bg-blue-700
...
export default {
  ...
  created() {
      this.pelis = JSON.parse(JSON.stringify(this.movies.Search));
  ...
  methods: {
    buscarMovie(){
        ...
        axios.post('api/searchMovie',{movie:this.busqueda}).then((res)=>{
                console.log(res);
                this.pelis = res.data.movies.Search;
        })
    }
  },
};
